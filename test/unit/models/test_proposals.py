...
def go_list_proposals():
    items = [
        {u'AbsoluteYesCount': 1000,
         ...
         u'DataString': u'[["proposal", {"end_epoch": 2122520400, "name": "dean-miller-5493", "payment_address": "TSTfeMeWwQiCDwMSTWRaj9wwVGNjZFfvFk", "payment_amount": 25.75, "start_epoch": 1474261086, "type": 1, "url": "http://vircles.org"}]]',
        ...
        {u'AbsoluteYesCount': 1000,
         ...
         u'DataString': u'[["proposal", {"end_epoch": 2122520400, "name": "fernandez-7625", "payment_address": "TSTfeMeWwQiCDwMSTWRaj9wwVGNjZFfvFk", "payment_amount": 25.75, "start_epoch": 1474261086, "type": 1, "url": "http://vircles.org/"}]]',
...
def proposal():
    ...
    pobj = Proposal(
        ...
        url="https://vircles.org/wine-n-cheeze-party",
...
def test_proposal_is_valid(proposal):
    ...
    proposal.url = 'http://virclescentral.org/dean-miller 5493'
    assert proposal.is_valid() is False

    proposal.url = 'http://virclescentralisé.org/dean-miller-5493'
    assert proposal.is_valid() is True

    proposal.url = 'http://virclescentralisé.org/dean-миллер-5493'
    assert proposal.is_valid() is True
    ...
    # ============================================================
    # ensure proposal can't request negative vircles
    # ============================================================
...
def test_approved_and_ranked(go_list_proposals):
    ...
    for item in go_list_proposals:
        (go, subobj) = GovernanceObject.import_gobject_from_virclesd(virclesd, item)
