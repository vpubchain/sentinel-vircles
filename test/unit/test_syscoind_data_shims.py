...
# TODO: remove fixtures below here once test_SHIM_serialise_for_virclesd removed
...
def test_extract_object():
    ...
    expected = {
        'type': 1,
        'name': 'jack-sparrow-new-ship-using-vircles',
        'url': 'https://whitepaper.vircles.org',
